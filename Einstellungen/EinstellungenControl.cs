...
{
  private static readonly string CoitToolkitQuickactionsClockodoEnvironmentKey = "COIT_TOOLKIT_QUICKACTIONS_CLOCKODO";
  ...
  public EinstellungenControl(EnvironmentManager environmentManager, AesCryptographyService cryptographer)
  {
    InitializeComponent();
  ...
  private async Task ClockodoEinstellungenPrüfenUndSpeichern()
  {
    ...
    {
      MessageBox.Show(speicherErgebnis.Error, "Hinweis", MessageBoxButtons.OK, MessageBoxIcon.Warning);
      return;
    }
  ...
  internal delegate void EinstellungenGeladenEventHandler(object sender, EinstellungenGeladenEventArgs e);
}
